...
A key problem which can throw off the performance of logistic regression is the possibility of bias in the data. To quote Marcos Lopez de Prado:

> ...backtest overfitting is arguably the most important open problem in all of mathematical finance  - Advances in Machine Learning

And if you have overfit the model, you are building it in favor of bias.

In a 1997 paper, __ Firth suggested a tweak to the maximum likelihood function to compensate for the bias term. Typically, we define the critical value of the maximum likelihood function $l$ as being:
...
# How does Firth's logistic regression remediate separation?
...
![](Notes_for_Firth_s_Logistic_Regression_files/figure-html/unnamed-chunk-3-1.png)<!-- -->
...
In my specific domain, finance, there should be no hard and fast rules dictating the binary outcome.
